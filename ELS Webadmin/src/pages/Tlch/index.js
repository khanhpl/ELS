            ...
            <Row className="lg:pr-[4px] xl:pr-[5px] 2xl:pr-[6px] 3xl:pr-[7px] w-[100%]">
              <Column className="lg:mt-[6px] xl:mt-[7px] 2xl:mt-[8px] 3xl:mt-[9px] w-[71%]">
                ...
                <Text className="font-normal lg:mt-[10px] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[16px] not-italic lg:text-[12px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[19px] text-indigo_300 w-[auto]">
                  Danh sách các đơn hàng của ElderlySitter
                </Text>
              </Column>
              <Img
              ...
              >
                <Row className="bg-white_A700 border border-blue_50 border-solid items-center my-[0] xl:p-[10px] 2xl:p-[12px] 3xl:p-[14px] lg:p-[9px] w-[100%]">
                  ...
                  <Img
                    ...
                    alt="sort"
                  />
                  <Text className="font-medium lg:ml-[49px] xl:ml-[56px] 2xl:ml-[63px] 3xl:ml-[75px] xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[9px] text-black_900 w-[auto]">
                    Nhân viên chăm sóc
                  </Text>
                  <Text className="font-medium lg:mb-[4px] xl:mb-[5px] 2xl:mb-[6px] 3xl:mb-[7px] lg:ml-[11px] xl:ml-[13px] 2xl:ml-[15px] 3xl:ml-[18px] 3xl:mt-[10px] lg:mt-[7px] xl:mt-[8px] 2xl:mt-[9px] xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[9px] text-black_900 w-[auto]">
                    Tên khách hàng
                  </Text>
                  <Img
                    src="images/img_sort.svg"
                    ...
                    alt="sort One"
                  />
                  <Text className="font-medium lg:ml-[41px] xl:ml-[47px] 2xl:ml-[53px] 3xl:ml-[63px] xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[9px] text-black_900 w-[auto]">
                    Dịch vụ
                  </Text>
                  <Img
                    src="images/img_sort.svg"
                    ...
                    alt="sort Two"
                  />
                  <Text className="font-medium mb-[4px] lg:ml-[101px] xl:ml-[116px] 2xl:ml-[131px] 3xl:ml-[157px] 2xl:mt-[11px] 3xl:mt-[13px] lg:mt-[8px] xl:mt-[9px] xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[9px] text-black_900 w-[auto]">
                    Tình trạng
                  </Text>
                  <Img
                    src="images/img_sort.svg"
                    className="2xl:h-[10px] 3xl:h-[11px] lg:h-[7px] xl:h-[9px] 2xl:ml-[10px] 3xl:ml-[12px] lg:ml-[7px] xl:ml-[8px] 3xl:w-[10px] lg:w-[7px] xl:w-[8px] 2xl:w-[9px]"
                    alt="sort Three"
                  />
                </Row>
                <Row className="bg-white_A700 border border-blue_50 border-solid items-center my-[0] xl:p-[10px] 2xl:p-[12px] 3xl:p-[14px] lg:p-[9px] w-[100%]">
                  ...
                  <Text className="font-normal 3xl:ml-[117px] lg:ml-[76px] xl:ml-[87px] 2xl:ml-[98px] not-italic xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[9px] text-black_900 w-[auto]">
                    Chăn sóc y tế̀
                  </Text>
                  <Row className="bg-white_A700 items-center justify-center mb-[4px] 3xl:ml-[102px] lg:ml-[66px] xl:ml-[75px] 2xl:ml-[85px] p-[4px] rounded-radius8 shadow-bs w-[10%]">
                  ...
                  <Img
                    ...
                    className="xl:h-[4px] lg:h-[4px] 3xl:h-[5px] 2xl:h-[5px] lg:ml-[172px] xl:ml-[197px] 2xl:ml-[222px] 3xl:ml-[266px] w-[2%]"
                    alt="shape One"
                  />
                </Row>
                <Row className="bg-white_A700 border border-blue_50 border-solid items-end my-[0] 2xl:p-[10px] 3xl:p-[12px] lg:p-[7px] xl:p-[8px] w-[100%]">
                  ...
                  <Text className="font-normal 2xl:ml-[102px] 3xl:ml-[122px] lg:ml-[79px] xl:ml-[90px] lg:my-[6px] xl:my-[7px] 2xl:my-[8px] 3xl:my-[9px] not-italic xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[9px] text-black_900 w-[auto]">
                    Chăn sóc y tế̀
                  </Text>
                  <Row className="bg-white_A700 items-center justify-center lg:mb-[6px] xl:mb-[7px] 2xl:mb-[8px] 3xl:mb-[9px] 3xl:ml-[105px] lg:ml-[68px] xl:ml-[78px] 2xl:ml-[88px] p-[4px] rounded-radius8 shadow-bs w-[9%]">
                  ...
                  <Img
                    src="images/img_shape_black_900.svg"
                    className="xl:h-[4px] lg:h-[4px] 3xl:h-[5px] 2xl:h-[5px] lg:ml-[178px] xl:ml-[203px] 2xl:ml-[229px] 3xl:ml-[274px] lg:my-[11px] xl:my-[13px] 2xl:my-[15px] 3xl:my-[18px] w-[2%]"
                    alt="shape Two"
                  />
                </Row>
              </List>
