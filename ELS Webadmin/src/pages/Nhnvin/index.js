    ...
    <>
      <Column className="bg-white_A700 font-poppins items-center mx-[auto] lg:p-[17px] xl:p-[20px] 2xl:p-[23px] 3xl:p-[27px] shadow-bs3 w-[100%]">
        <Row className="lg:mb-[29px] xl:mb-[33px] 2xl:mb-[38px] 3xl:mb-[45px] lg:mt-[10px] xl:mt-[12px] 2xl:mt-[14px] 3xl:mt-[16px] w-[98%]">
          <Column className="lg:mb-[26px] xl:mb-[30px] 2xl:mb-[34px] 3xl:mb-[40px] w-[19%]">
            ...
            <Column className="lg:ml-[23px] xl:ml-[26px] 2xl:ml-[30px] 3xl:ml-[36px] 3xl:mt-[104px] lg:mt-[67px] xl:mt-[77px] 2xl:mt-[87px] w-[75%]">
              ...
              <Row className="lg:ml-[5px] xl:ml-[6px] 2xl:ml-[7px] 3xl:ml-[8px] lg:mt-[230px] xl:mt-[263px] 2xl:mt-[296px] 3xl:mt-[355px] w-[64%]">
                <Img
                  src="images/img_ticket.svg"
          ...
          <Column className="items-center lg:ml-[30px] xl:ml-[34px] 2xl:ml-[39px] 3xl:ml-[46px] mt-[2px] w-[78%]">
            <Row className="lg:pr-[4px] xl:pr-[5px] 2xl:pr-[6px] 3xl:pr-[7px] w-[100%]">
              <Column className="lg:mt-[3px] xl:mt-[4px] 2xl:mt-[5px] 3xl:mt-[6px] w-[71%]">
                ...
                <Text className="font-normal lg:mt-[13px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[20px] not-italic lg:text-[12px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[19px] text-indigo_300 w-[auto]">
                  Danh sách các nhân viên chăm sóc của ElderlySitter
                </Text>
              </Column>
              <Img
            ...
            <Column className="bg-white_A700 border border-blue_50 border-solid items-center justify-end lg:mt-[34px] xl:mt-[39px] 2xl:mt-[44px] 3xl:mt-[52px] lg:p-[15px] xl:p-[17px] 2xl:p-[20px] 3xl:p-[24px] rounded-radius10 w-[100%]">
              ...
              <List
                className="gap-[0] min-h-[auto] lg:mt-[13px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[20px] w-[100%]"
              ...
              >
                <Row className="bg-white_A700 border border-blue_50 border-solid my-[0] xl:p-[10px] 2xl:p-[12px] 3xl:p-[14px] lg:p-[9px] w-[100%]">
                  ...
                  <Img
                    ...
                    alt="sort Two"
                  />
                  <Text className="font-medium mb-[4px] xl:ml-[100px] 2xl:ml-[113px] 3xl:ml-[135px] lg:ml-[87px] 2xl:mt-[11px] 3xl:mt-[13px] lg:mt-[8px] xl:mt-[9px] xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[9px] text-black_900 w-[auto]">
                    Tình trạng
                  </Text>
                  <Img
                    src="images/img_sort.svg"
                ...
                <Row className="bg-white_A700 border border-blue_50 border-solid items-end my-[0] xl:p-[10px] 2xl:p-[12px] 3xl:p-[14px] lg:p-[9px] w-[100%]">
                  <Text className="font-normal lg:my-[6px] xl:my-[7px] 2xl:my-[8px] 3xl:my-[9px] not-italic xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[9px] text-black_900 w-[auto]">
                    1
                  </Text>
                  <Text className="font-normal lg:ml-[44px] xl:ml-[50px] 2xl:ml-[57px] 3xl:ml-[68px] lg:my-[6px] xl:my-[7px] 2xl:my-[8px] 3xl:my-[9px] not-italic xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[9px] text-black_900 w-[auto]">
                    #12594
                  </Text>
                  <Text className="font-normal lg:ml-[54px] xl:ml-[62px] 2xl:ml-[70px] 3xl:ml-[84px] lg:my-[6px] xl:my-[7px] 2xl:my-[8px] 3xl:my-[9px] not-italic xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[9px] text-black_900 w-[auto]">
                    Phan Văn A
                  </Text>
                  <Text className="font-normal lg:mb-[4px] xl:mb-[5px] 2xl:mb-[6px] 3xl:mb-[7px] lg:ml-[54px] xl:ml-[62px] 2xl:ml-[70px] 3xl:ml-[84px] 3xl:mt-[10px] lg:mt-[7px] xl:mt-[8px] 2xl:mt-[9px] not-italic xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[9px] text-black_900 w-[auto]">
                    Nhân viên cấp cao
                  </Text>
                  <Text className="font-normal lg:mb-[4px] xl:mb-[5px] 2xl:mb-[6px] 3xl:mb-[7px] lg:ml-[40px] xl:ml-[46px] 2xl:ml-[52px] 3xl:ml-[62px] 3xl:mt-[10px] lg:mt-[7px] xl:mt-[8px] 2xl:mt-[9px] not-italic xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[9px] text-black_900 w-[auto]">
                    Chứng chỉ điều dưỡng
                  </Text>
                  <Row className="bg-white_A700 items-center justify-center mb-[4px] lg:ml-[26px] xl:ml-[30px] 2xl:ml-[34px] 3xl:ml-[40px] p-[4px] rounded-radius8 shadow-bs w-[13%]">
                  ...
                  <Img
                    ...
                    className="xl:h-[4px] lg:h-[4px] 3xl:h-[5px] 2xl:h-[5px] lg:ml-[151px] xl:ml-[173px] 2xl:ml-[195px] 3xl:ml-[234px] lg:my-[10px] xl:my-[11px] 2xl:my-[13px] 3xl:my-[15px] w-[2%]"
                    alt="shape One"
                  />
                </Row>
                <Row className="bg-white_A700 border border-blue_50 border-solid items-end my-[0] 2xl:p-[10px] 3xl:p-[12px] lg:p-[7px] xl:p-[8px] w-[100%]">
                  ...
                  <Text className="font-normal lg:ml-[57px] xl:ml-[65px] 2xl:ml-[74px] 3xl:ml-[88px] 2xl:my-[10px] 3xl:my-[12px] lg:my-[7px] xl:my-[8px] not-italic xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[9px] text-black_900 w-[auto]">
                    Nhân viên mới
                  </Text>
                  <Text className="font-normal lg:ml-[60px] xl:ml-[69px] 2xl:ml-[78px] 3xl:ml-[93px] 2xl:my-[10px] 3xl:my-[12px] lg:my-[7px] xl:my-[8px] not-italic xl:text-[10px] 2xl:text-[12px] 3xl:text-[14px] lg:text-[9px] text-black_900 w-[auto]">
                    Chưa có
                  </Text>
                  <Row className="bg-white_A700 items-center justify-center lg:mb-[6px] xl:mb-[7px] 2xl:mb-[8px] 3xl:mb-[9px] xl:ml-[105px] 2xl:ml-[119px] 3xl:ml-[142px] lg:ml-[92px] p-[4px] rounded-radius8 shadow-bs w-[11%]">
                  ...
                  <Img
                    src="images/img_shape_black_900.svg"
                    className="xl:h-[4px] lg:h-[4px] 3xl:h-[5px] 2xl:h-[5px] lg:ml-[159px] xl:ml-[182px] 2xl:ml-[205px] 3xl:ml-[246px] lg:my-[11px] xl:my-[13px] 2xl:my-[15px] 3xl:my-[18px] w-[2%]"
                    alt="shape Two"
                  />
                </Row>
              </List>
