                              ...
                              child: Container(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                                                    ...
                                                                    Padding(
                                                                        ...
                                                                        child: Text(
                                                                            ...
                                                                            overflow:
                                                                                TextOverflow.ellipsis,
                                                                            textAlign: TextAlign.left,
                                                                            style: AppStyle.txtRobotoRomanRegular17.copyWith(height: 1.00)))
                                                                  ])))
                                                    ]))),
                                        Container(
                                        ...
                                        Padding(
                                            padding: getPadding(
                                                left: 32, top: 35, right: 32),
                                            child: Text("lbl_ho_c_s_d_ng".tr,
                                                                    ...
                                                                    child: Stack(
                                                                        children: [
                                                                          Align(
                                                                              ...
                                                                              child: Padding(padding: getPadding(all: 1), child: CommonImageView(svgPath: ImageConstant.imgPath14, height: getVerticalSize(22.00), width: getHorizontalSize(23.00))))
                                                                        ])),
                                                                Padding(
                                                                    padding: getPadding(
                                                                        left:
