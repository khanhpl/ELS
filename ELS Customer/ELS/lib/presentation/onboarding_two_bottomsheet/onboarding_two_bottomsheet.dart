import '../onboarding_two_bottomsheet/widgets/slidermakeaschedule_item_widget.dart';
...
class OnboardingTwoBottomsheet extends StatelessWidget {
  OnboardingTwoBottomsheet(this.controller);

  OnboardingTwoController controller;
                      ...
                      child: Obx(
                        () => CarouselSlider.builder(
                          ...
                          itemCount: controller.onboardingTwoModelObj.value
                              .slidermakeascheduleItemList.length,
                          itemBuilder: (context, index, realIndex) {
                            SlidermakeascheduleItemModel model = controller
                                .onboardingTwoModelObj
                                .value
                                .slidermakeascheduleItemList[index];
                            return SlidermakeascheduleItemWidget(
                              model,
                            );
                          },
                        ),
