class CustomerDetailDataModel {
  ...
  factory CustomerDetailDataModel.fromJson(Map<String, dynamic> json) => CustomerDetailDataModel(
    id: json["id"],
    ...
    frontIdImgUrl: (json["frontIdImgUrl"] != null)?json["frontIdImgUrl"]:"",
    backIdImgUrl: (json["backIdImgUrl"] != null)?json["backIdImgUrl"]:"",
  );
