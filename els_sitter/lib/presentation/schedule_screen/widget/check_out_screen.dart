...
class CheckOutScreen extends StatefulWidget{
  ...
  @override
  State<CheckOutScreen> createState() => _CheckOutScreenState(bookingID: this.bookingID);
}
...
class _CheckOutScreenState extends State<CheckOutScreen> {
  ...
  Future _getCheckOutImageFromGallery() async {
    ...
    print('Download link checkout: ${urlDownload}');
  }
  ...
  onCheckOutClick() async {
    ...
    isCheckOut = await _bookingBloc.sitterCheckOutAction(bookingID, checkoutImgImage);
